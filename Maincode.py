"""
Maincode.py - Main simulation for the FOP PracTest 03 task 03, Sem 1 2024

Written by : Nipuna Hansika Samarasinghe
Student ID : 22084280

Usage: Main code for the whole program
...
from creatures import Toy, Newscar, Tree, Newspaper, SunMoon, Car, Pond
...
def update_smells(smells, creatures):
    pass
welcome = ("\n\n\n\t\t\t***** Welcome to the Puppy Simulation! *****")
print(welcome)
Question = ("\n\nPlease select one of the given scenarios: ")
print(Question)
scenario1 = ("\n\t1. For MORNING Scenario Please Type - M  ")
scenario2 = ("\n\t2. For EVENING Scenario Please Type - E  ")
scenario3 = ("\n\t3. For NIGHT Scenario Please Type   - N  ")
print(scenario1)
print(scenario2)
print(scenario3)
takeinput = input ("\n\nType Your Required Scenario Here (M/E/N):..   ").upper()
# EVERYTHING ABOUT MORNING
if takeinput == 'M':
    def plot_yard(ax, p):
    ...
    def main():
        ...
        snoopy = MSnoopy("Bark!! Bark!!", "orange/black", (98,5))
        newscar = Newscar("Ausi news", "white/gray", (110,18))

        rover = MRover("Rover", "brown/black", (30,25))
        rocky = MSquirrel("RockY", "gray/black", (25,160))

        homeman = MHomeman("Guy", "beige/brown", (65,65))
        otherman = MOtherman("Father", "beige/black", (20,5))

        newspaper = Newspaper("Newspaper", "White/white",(111,81))

        pond = Pond("Pond", "Blue/White", (5,10))

        cast = [snoopy, rover, rocky, newscar, homeman, otherman, newspaper]

        toy1 = Toy("Ball1", "red", (24,8), True)
        toy2 = SunMoon("Ball2", "tomato", (1,1), True)
        ...
        for timestep in range(61):
            ...
            cast[6].step_change(timestep)
            cast[6].plot_me(axs, size, timestep)
...
# EVERYTHING ABOUT EVENING
    ...
    def main():
        ...
        snoopy = ESnoopy("Bark!! Bark!!", "orange/black", (30,25))
        car = Car("Ausi news", "red/gray", (110,18))

        rover = ERover("Rover", "brown/black", (32,27))
        rocky = ESquirrel("RockY", "gray/black", (25,10))

        homeman = EHomeman("Guy", "beige/brown", (65,65))
        otherman = EOtherman("Father", "beige/black", (20,5))

        cast = [snoopy, rover, rocky, car, homeman, otherman]

        toy1 = Toy("Ball1", "red", (24,8), True)
        toy2 = SunMoon("Ball2", "gold", (1,1), True)
...
# EVERYTHING ABOUT NIGHT
    ...
    def main():
        ...
        car1 = Car("Ausi news", "white/gray", (105,25))
        car2 = Car("Ausi news", "red/gray", (105,80))
        car3 = Car("Ausi news", "blue/gray", (105,140))
        car4 = Car("Ausi news", "green/gray", (105,160))
        ...
        cast = [snoopy, rover, rocky, car1, homeman, otherman, car2, car3, car4]
    ...
    print("Please use on of the given inputs!! (M/E/N) ")
    takeinput = input ("Would you like it to be Morning or Evening or Night:   (M/E/N)").upper()

print("\n\n**** Play Again For Another Scenario ****")
