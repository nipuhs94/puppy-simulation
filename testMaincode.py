"""
testMaincode.py - testing Main simulation for the FOP assessment, Sem 1 2024

Written by : Nipuna Hansika Samarasinghe
Student ID : 22084280

Usage: trying new things on the main code without damaging the main code
...
from creatures import MSnoopy, MRover, MSquirrel, Toy, Newscar, Tree, MHomeman, MOtherman
...
def build_yard(dims):
    ...
    plan[50:70,60:70] = 10 # door
    plan[50:60,85:90] = 10 # windows
    plan[50:60,95:100] = 0 # windows
    plan[50:60,105:110] = 10 # windows
...
# takeinput = input ("Would you like it to be Day or Night:   (D/N)").upper()
# if takeinput == 'D':
#     def plot_yard(ax, p):
#         ax.imshow(p, cmap= 'nipy_spectral') # data visualization day
# else:
#     def plot_yard(ax, p):
#         ax.imshow(p,) # data visualization night    

def plot_yard(ax, p):
    ax.imshow(p, cmap= 'nipy_spectral') # remove this later
